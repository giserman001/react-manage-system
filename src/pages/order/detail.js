...
export default class Detail extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <Card>
          <div id="orderDetailMap" className={style['order-map']}></div>
          <div className={style['detail-items']}>
            ...
            <ul className={style['detail-form']}>
              <li>
                ...
                <div className={style['detail-form-content']}>{info.mode === 1 ? '服务区' : '停车点'}</div>
              </li>
              <li>
          ...
          <div className={style['detail-items']}>
            ...
            <ul className={style['detail-form']}>
              ...
              <li>
                ...
                <div className={style['detail-form-content']}>{info.distance / 1000}公里</div>
              </li>
            </ul>
          </div>
        </Card>
